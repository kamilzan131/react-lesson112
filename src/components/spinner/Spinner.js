import loading from '../../resources/img/Rhombus.gif';
...
const Spinner = () => {
        return (
           /* <svg xmlns="http://www.w3.org/2000/svg" style={{margin: '0 auto', background: 'none', display: 'block'}}
                    ...
                    <g transform="translate(80,50)">
                            <g transform="rotate(0)">
                                    <circle cx="0" cy="0" r="7" fill="#1c4595" fillOpacity="1">
                                            ...
                                            <animate attributeName="fillOpacity" keyTimes="0;1" dur="1s"
                ...
                <img src={loading} style={{margin: '75px auto', background: 'none', display: 'block'}}
                     width="50px" height="50px" alt='loading image'/>
        );
}
